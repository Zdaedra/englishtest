# Отсев «искусственных» фраз — 811 фраз, 90 батчей, оценка по НИЖНЕМУ баллу двух судей

**Дата:** 2026-07-06 · Судьи: **GPT-5.5** (ChatGPT web) и **Claude Fable 5** (личная вычитка). Итог фразы = **минимум из двух оценок**: если хотя бы один судья счёл фразу неживой — она в отсеве. Шкала 1–10: живая речь носителя ↔ придуманный «AI-английский».

## Итого

- Фраз: **811**. По нижнему баллу слабых (min ≤6): **340** (42%)
- Распределение нижнего балла: 2: 1 · 3: 11 · 4: 48 · 5: 105 · 6: 175 · 7: 196 · 8: 204 · 9: 71
- Из 340 слабых: у **107** оба судьи ≤6 (бесспорный отсев), у **14** слабой посчитал только GPT, у **219** — только Fable
- Замена (`fix`) от GPT есть у фраз, где GPT сам ставил ≤6; для остальных замену надо сгенерировать отдельно

## ГЛАВНАЯ ТАБЛИЦА: все слабые фразы, худшие сверху (сортировка по нижнему баллу)

| Мин | GPT | Fable | Батч | Якорь | Фраза сейчас | Замена (GPT) |
|---|---|---|---|---|---|---|
| **2** | 2 | 3 | `stage-1` | Here | The room is mine — not because I took it, but because I'm already here. | I’m here, you’re here, so let’s make this worth the room. |
| **3** | 3 | 3 | `pitch-1` | Knife | Here's where the knife comes down — what actually matters. | Here’s the part that really matters. |
| **3** | 3 | 3 | `stage-2` | Air | I don't fill the air to feel in control — the space is already mine. | I don’t need to fill every second. Some points need space. |
| **3** | 3 | 3 | `stage-2` | Wait | I'm in no rush to fill it — watch the room wait for me. | I’m going to give that a second before we move on. |
| **3** | 3 | 3 | `stage-8` | pad | No thank-yous to pad it. Just the line — and the door. | No filler. Just this: the next move is yours. |
| **3** | 4 | 3 | `intimacy-12` | Presence | My desire for you comes from presence — not from needing you to complete me. | I want you because I’m here with you, not because I need you to fix something in me. |
| **3** | 4 | 3 | `composure-9` | Sweet | My choice stays mine — even when the room gets sweet. | My choice is still mine, even when the pitch is warm. |
| **3** | 4 | 3 | `gravitas-6` | Over | Bigger than me doesn't mean over me — not in this room. | You may have more authority here, but I still need to say what I see. |
| **3** | 5 | 3 | `composure-6` | Composure | I won't spend my composure on a conversation that's lost its center. | I’m not going to keep spending energy on a conversation that’s lost the point. |
| **3** | 3 | 5 | `gravitas-2` | Inside | Whatever's shaking inside stays inside — what you get from me is steady. | I may feel the pressure, but I’m going to stay steady for the room. |
| **3** | 5 | 3 | `stage-3` | stiffen | A lens doesn't make me stiffen. I breathe, I slow, I stay me. | The lens is just a person on the other side. I breathe, slow down, and stay myself. |
| **3** | 6 | 3 | `composure-9` | Bought | Good feeling isn't how my judgment gets bought. | A good feeling doesn’t change my judgment here. |
| **4** | 4 | 4 | `pitch-1` | Grab | This is the line that should grab you. | This is the part that should make you lean in. |
| **4** | 4 | 4 | `pitch-3` | Bridge | So here's the bridge from where we are to where this goes. | So here’s how we get from here to there. |
| **4** | 4 | 4 | `pitch-3` | Door | I'm opening one door — you decide if you walk through it. | I’m putting a real option in front of you. You can decide if it’s worth pursuing. |
| **4** | 4 | 4 | `pitch-3` | Room | I want to be the obvious person you back in this room. | I want to be the person you’re comfortable backing in this room. |
| **4** | 4 | 4 | `intimacy-7` | Crack | This isn't a crack in me — it's a choice. | This isn’t me falling apart. It’s me choosing to be honest with you. |
| **4** | 4 | 4 | `lead-11` | Up | I'm calling you up — not bending you down. There's a difference, and you'll feel it. | I’m asking more of you because I know you’re capable of more. |
| **4** | 4 | 4 | `composure-1` | Lever | My reaction is my choice — never your lever. | My reaction is mine to choose. I’m not handing it over. |
| **4** | 4 | 4 | `composure-3` | Tall | This isn't landing the way you hoped — I'm still standing exactly as tall. | That didn’t land the way you hoped. Let’s get back to the point. |
| **4** | 4 | 4 | `gravitas-2` | Voice | The room can shake — my voice will not. | Things may be moving fast, but I’m going to stay steady. |
| **4** | 4 | 4 | `gravitas-4` | Count | Ask in any order — I'll answer in the order that makes this count. | Ask in any order. I’ll answer in the order that makes the most sense. |
| **4** | 4 | 4 | `gravitas-6` | Fold | I don't fold for power, and I don't fight it — I just hold. | I’m not here to fight power. I’m here to stay with the facts. |
| **4** | 4 | 4 | `gravitas-9` | Calm | The loudest thing in this room is calm. Let it do the work. | Let’s bring the energy down so we can actually think. |
| **4** | 4 | 4 | `stage-1` | Singular | Let me talk to you — singular — not to a room. | I want to talk to one person in this room, not to a crowd. |
| **4** | 4 | 5 | `charisma-2` | Deal | Here's my deal: ninety seconds, and you'll be glad you stopped. | Give me ninety seconds. If I’m boring, I’ll let you escape. |
| **4** | 5 | 4 | `flirt-10` | Carry | Let's carry this into a night that can hold it. | Let’s continue this somewhere that gives it a little more room. |
| **4** | 5 | 4 | `intimacy-8` | Sift | I'll sift it — take what lands, leave what doesn't. Calmly. | I’ll sit with it and take in the part that’s true. |
| **4** | 5 | 4 | `lead-1` | Gather | Let's gather this for a second — so we're not all carrying it separately. | Let’s pull this together for a second so we’re all working from the same picture. |
| **4** | 5 | 4 | `composure-2` | Beside | I'll let that land beside me — not on me. | I’m going to let that pass without taking it on. |
| **4** | 5 | 4 | `composure-3` | Shrink | You can't shrink me by trying to — that's just not how I work. | Trying to put me down isn’t going to move the conversation forward. |
| **4** | 5 | 4 | `composure-9` | Anchor | I can enjoy the charm and still keep my anchor. | I can appreciate the charm and still keep my position. |
| **4** | 5 | 4 | `stage-8` | trail | I'm not going to trail off — I'm landing this, right here. | I’m going to land this plainly. |
| **4** | 6 | 4 | `intimacy-10` | Freedom | I won't make my fear the manager of your freedom. | I won’t let my fear turn into control. |
| **4** | 6 | 4 | `lead-8` | Fact | Give me the fact — then what you need from it. | Give me the fact first, then tell me what you need. |
| **4** | 6 | 4 | `lead-8` | Frame | I'll just hold the frame until you actually hear each other. | I’ll hold the structure for a minute so you can actually hear each other. |
| **4** | 6 | 4 | `lead-10` | Taller | When we name excellence accurately, everyone stands taller. | When we give credit accurately, the whole team gets stronger. |
| **4** | 6 | 4 | `composure-7` | Hesitation | My pause isn't hesitation — it's the weight of doing this right. | I’m pausing because I want to get this right, not because I’m unsure. |
| **4** | 6 | 4 | `gravitas-2` | Deliberate | I'm speaking deliberately — the moment needs it. | I’m going to slow down because this needs to be precise. |
| **4** | 6 | 4 | `gravitas-3` | Fog | We're deciding in fog — not in failure. | We’re making this call with incomplete information, not because we’ve failed. |
| **4** | 6 | 4 | `gravitas-7` | Become | We can't choose how this ends — only who we become getting there. | We can’t control exactly how this ends. We can control how we handle it. |
| **4** | 6 | 4 | `gravitas-8` | Unwind | Bring it back to the consequence we can't unwind. | Bring it back to the consequence we can’t undo. |
| **4** | 6 | 4 | `gravitas-9` | Lower | I'll speak lower — because the stakes are high. | I’m going to lower my voice because this needs clarity, not volume. |
| **4** | 6 | 4 | `stage-3` | fillers | I'll land each sentence — no fillers, no drift. | I’m going to keep this tight: no filler, no wandering. |
| **4** | 6 | 4 | `stage-6` | stumble | One stumble does not get to own the room. | One stumble doesn’t get the whole room. Let’s keep going. |
| **4** | 4 | 6 | `stage-6` | forgettable | Flawless would've been forgettable. This, you'll remember. | Well, that made it memorable. Now back to the point. |
...
| **5** | 5 | 5 | `pitch-3` | Fit | The reason I'm bringing this to you specifically — it's a fit. | I’m bringing this to you specifically because I think it’s a strong fit. |
| **5** | 5 | 5 | `pitch-3` | Handshake | Let's not overthink it — handshake and we're moving. | Let’s not overthink it. If we’re aligned, let’s shake on it and move. |
| **5** | 5 | 5 | `charisma-1` | Momentum | Don't stop on my account — I love walking into momentum. | Don’t stop on my account. I like walking into a room with energy. |
| **5** | 5 | 5 | `flirt-8` | Smile | I caught that smile — I'm going to take it gently. | I caught that smile. I’m not going to overread it, but I noticed. |
| **5** | 5 | 5 | `intimacy-7` | Collapsing | I can say this without collapsing: I need you. | This is hard for me to say, but I need you. |
| **5** | 5 | 5 | `intimacy-7` | Steady | I'm telling you the truth because I'm steady enough to stand in it. | I’m telling you the truth because I feel steady enough to say it. |
| **5** | 5 | 5 | `intimacy-8` | Shatter | This doesn't shatter me — I can hear it and stay with you. | This is hard to hear, but I can hear it and stay with you. |
| **5** | 5 | 5 | `lead-11` | Waste | I'd rather expect a lot and mean it than flatter you and waste you. | I’d rather hold you to a high standard than pretend this is your best work. |
| **5** | 5 | 5 | `composure-1` | Button | My calm isn't a button you get to press. | You can try to push that button. I’m not going to give you the reaction. |
| **5** | 5 | 5 | `composure-2` | Inch | I know exactly who I am — that didn't move it an inch. | I know who I am. That didn’t change anything. |
| **5** | 5 | 5 | `composure-3` | Ounce | I don't lose an ounce of standing because you raised your voice. | Raising your voice doesn’t make your point stronger. |
| **5** | 5 | 5 | `gravitas-5` | Helm | I take the hit and I keep the helm. Both. Here's where we start. | I’m taking responsibility, and I’m staying in the seat to fix it. |
| **5** | 5 | 5 | `gravitas-7` | Upright | Whatever comes, we meet it upright. That part I guarantee. | Whatever happens, we’ll meet it honestly and stay steady. |
| **5** | 5 | 5 | `stage-3` | reads | I'm not acting for you — and that's exactly what reads. | I’m not going to perform at you. I’m just going to talk to you. |
| **5** | 5 | 5 | `stage-11` | thought | I don't need a plan. I've got a thought — and that's plenty. | I don’t need the original plan. The main idea still holds. |
| **5** | 6 | 5 | `pitch-1` | Catch | Most people miss this, and that's the whole catch. | Most people miss this, and that’s where the opportunity is. |
| **5** | 6 | 5 | `pitch-1` | Lean | Lean in — this is the part nobody talks about. | Here’s the part most people don’t talk about. |
| **5** | 5 | 6 | `charisma-2` | Watching | I've been watching the room — you're the only one not working it. | I noticed you’re the only one here who doesn’t seem to be working the room. |
| **5** | 6 | 5 | `charisma-10` | Casually | I don't make introductions casually — this one has range. | I don’t make introductions casually. I think this one could go somewhere. |
| **5** | 6 | 5 | `charisma-11` | Date | No backlog, no apologies — just give me a date. | No big apology, no long catch-up preface — just tell me when I can see you. |
| **5** | 6 | 5 | `flirt-3` | Smaller | I'm not going to make this smaller by explaining it. | I don’t want to over-explain it and ruin it. |
| **5** | 5 | 6 | `flirt-6` | Errand | I'm not offering you an errand — I'm offering you a night you'll remember. | I’m not asking you to squeeze me in. I’m asking you out properly. |
| **5** | 6 | 5 | `intimacy-2` | Dignity | I can hold my dignity and still stay close to you. | I don’t want to lose myself here, but I also don’t want to pull away from you. |
| **5** | 6 | 5 | `intimacy-9` | Desire | I want you in my future from desire — not from fear. | I want you in my future because I choose you, not because I’m afraid to be without you. |
| **5** | 6 | 5 | `lead-3` | Steady | Stay with me. We move steady from here. | Stay with me. We move steadily from here. |
| **5** | 6 | 5 | `lead-4` | Expensive | I'd rather be uncomfortable now than quiet and expensive later. | I’d rather have the uncomfortable conversation now than pay for the silence later. |
| **5** | 5 | 6 | `lead-5` | Landed | Here's the fact: you committed to this, and it didn't land. What happened? | Here’s the fact: you committed to this, and it didn’t happen. What got in the way? |
| **5** | 6 | 5 | `lead-5` | Dignity | I'm going to protect the standard without taking away your dignity. | I want to keep the standard high without making this personal. |
| **5** | 6 | 5 | `lead-10` | Light | I don't need to stand in someone else's light to be seen. | Giving someone else credit doesn’t take anything away from me. |
| **5** | 6 | 5 | `lead-11` | Invitation | This isn't pressure — it's an invitation to be who you already are at your best. | This isn’t pressure. It’s an invitation to do the level of work I know you can do. |
| **5** | 5 | 6 | `composure-1` | Strings | Pull all the strings you want — they're not attached to anything. | You can keep pulling on that. I’m not going with it. |
| **5** | 6 | 5 | `composure-2` | Worth | Your words don't get to define my worth. | That doesn’t define me, and I’m not going to treat it like it does. |
| **5** | 6 | 5 | `composure-4` | Own | A small miss doesn't get to own the room. | Small miss. Let’s not give it the whole room. |
| **5** | 6 | 5 | `composure-6` | Kindly | I'm going to step away kindly — not angrily. | I’m going to step away from this without anger. |
| **5** | 6 | 5 | `composure-9` | Lovely | Lovely words — I'm keeping them and my position both. | That’s kind of you to say. My position is still the same. |
| **5** | 6 | 5 | `stage-2` | Hang | I'll let that line hang. The silence is on my side. | I’ll let that line hang for a second. |
| **5** | 6 | 5 | `stage-4` | fuel | This isn't fear — it's fuel. Same chemistry, my label on it. | I’m going to use the nerves as fuel and keep going. |
| **5** | 5 | 6 | `stage-6` | fall | It's not the fall — it's how I get up. Watch. | The recovery is the point. Let’s keep going. |
| **5** | 6 | 5 | `stage-7` | wait | And here's the turn. [pause] Wait for it. | And here’s the turn. Pause with me for a second. |
| **5** | 6 | 5 | `stage-8` | believe | You walked in as a crowd. You're leaving as people I believe in. | You walked in as a crowd. I hope you leave feeling personally responsible for what happens next. |
| **5** | 6 | 5 | `stage-9` | armor | I don't want to put on armor and call it transparency. | I don’t want to hide behind corporate language and call it transparency. |
| **5** | 7 | 5 | `charisma-1` | Name | Let me name the thing the room's been circling. | — |
| **5** | 5 | 7 | `charisma-4` | Changed | Going around: one thing you've changed your mind about this year — I'll start. | Let’s go around: what’s one thing you’ve changed your mind about this year? I’ll start. |
| **5** | 5 | 7 | `flirt-3` | Away | This is the part where someone usually looks away — I won't. | This is the part where people usually look away. I kind of don’t want to. |
...
| **5** | 5 | 7 | `lead-8` | Crown | I'm not here to crown a winner — I'm here to get you hearing each other. | I’m not here to pick a winner. I’m here to get us to a workable answer. |
...
| **6** | 6 | 6 | `batch-3` | Underneath | Help me see what's really going on underneath. | Help me understand what’s really driving this. |
| **6** | 6 | 6 | `pitch-1` | Picture | Picture this — it's Monday morning and the whole thing already broke. | Picture this: it’s Monday morning, and the whole thing is already on fire. |
| **6** | 6 | 6 | `pitch-2` | Tide | The tide just turned — and here's why now. | The tide just turned, and here’s why that matters now. |
| **6** | 6 | 6 | `pitch-3` | Skin | I've got skin in this — I'm not asking you to go where I won't. | I’ve got skin in the game. I’m not asking you to take a risk I’m not taking myself. |
| **6** | 6 | 6 | `charisma-2` | Read | You look like you've got the real read on this room. | You look like you’ve got the best read on this room. |
| **6** | 6 | 6 | `flirt-5` | Charge | I'm enjoying the charge here — I don't want to pretend it's casual. | I’m enjoying the chemistry here, and I don’t really want to pretend it’s casual. |
| **6** | 6 | 6 | `flirt-7` | Dent | A no doesn't dent me — and it shouldn't cost you a thing. | A no is totally fine. I don’t want it to make things weird for you. |
| **6** | 6 | 6 | `flirt-8` | Pace | I like your pace — it makes me want to match it. | I like your pace. I’m happy to follow it. |
| **6** | 6 | 6 | `flirt-9` | Read | This is where I leave before I become too easy to read. | This is where I leave before I give away too much. |
| **6** | 6 | 6 | `flirt-10` | Almosts | Before this becomes one of those great almosts — let's put a plan on it. | Before this turns into one of those almosts, let’s put an actual plan on the calendar. |
| **6** | 6 | 6 | `flirt-10` | Electricity | Give me your number — I'll make sure the next time has the same electricity. | Give me your number. I’ll make sure the next time feels just as good. |
| **6** | 6 | 6 | `intimacy-1` | Close | I want to talk about something — because I want us close, not because I want us hurt. | I want to talk about something because I want us to feel close, not hurt each other. |
| **6** | 6 | 6 | `intimacy-3` | Reach | I'm reaching out first, on purpose. Take my hand. | I’m reaching out first because I don’t want this distance between us. |
| **6** | 6 | 6 | `intimacy-8` | Grow | I don't need to defend my way out of this — I'd rather just grow. | I don’t want to defend my way out of this. I want to learn from it. |
| **6** | 6 | 6 | `lead-1` | Steer | Someone's got to steer this — so I will. Call it the moment you disagree. | Someone needs to steer this, so I’ll do it for now. Stop me if you disagree. |
| **6** | 6 | 6 | `lead-2` | Yours | The part that excites me most is the piece that's so clearly yours. | The part that excites me most is the piece only you can really own. |
| **6** | 6 | 6 | `composure-2` | Describes | What you just said describes you, not me. | That says more about the tone of this conversation than it does about me. |
| **6** | 6 | 6 | `composure-6` | Afraid | I'm not leaving because I'm afraid — I'm leaving because this deserves better. | I’m not walking away from the issue. I’m walking away from the way we’re talking about it. |
| **6** | 6 | 6 | `stage-4` | run | Fear doesn't run this room. I do. | The nerves don’t get to run this room. I do. |
| **6** | 6 | 6 | `stage-10` | tell | Some of you are feeling it right now — I can tell. That's exactly the point. | Some of you are feeling it right now. That’s exactly the point. |
...
| **6** | 6 | 7 | `repair-1` | Better | I'll do better from here. | I’ll do better going forward. |
| **6** | 6 | 7 | `charisma-3` | Light | You lit up when you said that — what's underneath it? | You lit up when you said that. What’s behind it? |
...
| **6** | 6 | 7 | `charisma-11` | List | I keep a very short list of people worth keeping — you never came off it. | There are very few people I’d go out of my way to keep in my life — you’re one of them. |
| **6** | 6 | 7 | `flirt-1` | Lightly | I don't give my attention lightly — and you have it. | I don’t get pulled in that easily, but you’ve got my attention. |
| **6** | 6 | 7 | `flirt-1` | Easy | I've said my piece — where it goes is up to you, and I'm easy either way. | I’ve said my piece. Where it goes is up to you, and I’m good either way. |
| **6** | 7 | 6 | `flirt-3` | Pause | I like this little pause between us. | — |
| **6** | 6 | 7 | `flirt-3` | Comfortable | I'm comfortable right here — the question is whether you are. | I’m comfortable with this. Are you? |
| **6** | 6 | 7 | `flirt-4` | Full | You've got my full attention — that's rarer than it sounds. | You’ve got my full attention, which doesn’t happen that often. |
...
| **6** | 6 | 7 | `flirt-6` | Boring | I don't do boring — say yes and find out exactly what I mean. | I don’t do boring dates. Say yes and I’ll prove it. |
...
| **6** | 6 | 7 | `intimacy-1` | Survive | Whatever gets said, we're still us when it's over. We survive this. | Whatever gets said, I want us to stay connected through it. |
...
| **6** | 6 | 7 | `stage-11` | raw | Unscripted and raw beats polished and dead. Lucky you. | Unscripted beats polished when the room is right. Lucky us. |
...
| **6** | 6 | 8 | `charisma-7` | Lightly | I don't say this lightly — | I don’t say this lightly: that was excellent. |
